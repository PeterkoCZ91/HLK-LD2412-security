...
void MQTTService::publishDiscoveryStep() {
    ...
    switch (_discoveryIndex) {
        ...
        case 6:  publishOneDiscovery("sensor", "rssi", "WiFi Signal", _topics.rssi, "dBm", "mdi:wifi", "signal_strength", "{\"ent_cat\":\"diagnostic\"}"); break;
        ...
        default: {
            // Engineering gates: indices 24-51 (14 gates × 2: moving + static)
            int gateOffset = _discoveryIndex - 24;
