...
// Timeouts
constexpr unsigned long TIMEOUT_WIFI_FAILOVER_MS     = 60000;     // WiFi failover base interval (60s)
...
constexpr uint8_t WIFI_FAILOVER_MAX_ATTEMPTS         = 10;
constexpr unsigned long WIFI_FAILOVER_MAX_INTERVAL_MS = 600000;   // Max backoff cap (10 min)
...
constexpr unsigned long COOLDOWN_WIFI_ANOMALY_MS     = 300000;    // WiFi anomaly alert cooldown (5 min)
...
constexpr unsigned long TIMEOUT_LOW_RSSI_SUSTAINED_MS = 120000;   // Sustained low RSSI threshold (2 min)
